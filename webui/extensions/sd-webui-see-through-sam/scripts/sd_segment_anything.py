...
# 导入图层分离模块
try:
    from layer_separation_module import create_layer_separation_ui
except ImportError as e:
    create_layer_separation_ui = None
    print(f"Warning: Could not import layer_separation_module: {e}")


def segmentation_tab():
    """创建图像分割/抠图/清理/图层分离标签页"""
