...
// ============================================================
// Graphical Aspect Ratio Shape Button Click Handler
// ============================================================
function setupArhShapeButtons() {
    const buttons = document.querySelectorAll('.arh-shape-btn');
...
// Try to set up shape buttons immediately and on DOM changes
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(setupArhShapeButtons, 1000);
    setTimeout(setupArhShapeButtons, 3000);
});

// Watch for dynamically added buttons
const arhObserver = new MutationObserver(function() {
    if (document.querySelector('.arh-shape-btn')) {
        setupArhShapeButtons();
    }
});
if (document.body) {
    arhObserver.observe(document.body, { childList: true, subtree: true });
} else {
    document.addEventListener('DOMContentLoaded', function() {
        arhObserver.observe(document.body, { childList: true, subtree: true });
    });
